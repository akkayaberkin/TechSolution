...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Kayit, Android < 4 will pass this test, but can only animate
    ...
    tests['cssgradients'] = function() {
         ...
         * webkit.org/Tech/175/introducing-css-gradients/
    ...
    // Kayit: in some older browsers, "no" was a return value instead of empty string.
    ...
    // Kayit that the property names must be provided in the camelCase variant.
