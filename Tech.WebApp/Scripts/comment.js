...
function doComment(btn, e, commentid, spanid) {
    ...
    if (e === "edit_clicked") {
        if (!mode) {
            ...
            btnSpan.removeClass("fa-solid fa-pen-to-square");
            btnSpan.addClass("fa-solid fa-check");
            ...
            var btnSpan = button.find("span");
            btnSpan.addClass("fa-solid fa-pen-to-square");
            btnSpan.removeClass("fa-solid fa-check");
