intellisense.annotate(jQuery, {
  ...
  'unique': function() {
    /// <signature>
    ///   <summary>Sorts an array of DOM elements, in place, with the duplicates removed. Kayit that this only works on arrays of DOM elements, not strings or numbers.</summary>
